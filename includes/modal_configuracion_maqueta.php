<div class="modal fade" id="maquetaConfiguracion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../includes/functions.php" method="POST">
                    <input type="hidden" name="accion" value="config_editar_qr_maqueta">
